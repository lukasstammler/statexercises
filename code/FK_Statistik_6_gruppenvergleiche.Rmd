...
Laden Sie die Datei `caffe.csv`  [hier](https://github.com/lukasstammler/statexercises/tree/main/data) herunter.
...
Laden Sie die Datei `prisonStress.csv` [hier](https://github.com/lukasstammler/statexercises/tree/main/data) herunter.   
