...
Wir prüfen diese Frage anhand einer Zufallsstichprobe von 183 Physiotherapie-Studentinnen. Der Datensatz kann [hier](https://github.com/lukasstammler/statexercises/tree/main/data) heruntergeladen werden.
...
Führen Sie eine komplette statistische Analyse zu dieser Fragestellung durch. Legen Sie das Signifikanzniveau auf $\alpha$ = .05 fest. 
...
3. Sind die Daten gepaart oder unabhhängig?    
...
6. Vertrauensintervalle für $\hat{\mu}_{bmi}$ berechnen.
...
7. Einstichproben-t-Test durchführen   
...
Der durchschnittliche BMI von Physiotherapie-Studentinnen (Mittelwert = 21.377, 95%-CI [21.072, 21.682] $kg/m^2$) unterscheidet sich signifikant vom durchschnittlichen BMI von Schweizer Frauen im Alter von 20 - 29 Jahren (BMI = 23.7 $kg/m^2$). Physiotherapie-Studentinnen haben im Durchschnitt einen um -2.323 [-2.628, -2.018] $kg/m^2$ geringeren BMI als Schweizer Frauen, $t$ = -15.030, $df$ = 182, $p$ < 0.0001. (s.a. Video)   

<br/>

**Wilcoxon-Vorzeichenrangtest**  

Auf Grund der etwas fraglichen Normalverteilung der Prüfgrösse, kann auch ein Wilcoxon-Vorzeichenrangtest durchgeführt werden.  

1. Hypothesen  

* $H_0: \tilde{x}_{BMI} = 23.7$, $\tilde{x}$ = Median  
* $H_A: \tilde{x}_{BMI} \neq 23.7$   
